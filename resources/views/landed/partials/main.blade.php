<section id="banner">
    <div class="content">
        ...
        <span class="image"><img src="{{ asset('/landed/images/pic01.jpg') }}" alt="" /></span>
    </div>
...
<section id="two" class="spotlight style2 right">
    <span class="image fit main"><img src="{{ asset('/landed/images/pic03.jpg') }}" alt="" /></span>
    <div class="content">
        <header>
...
<section id="three" class="spotlight style3 left">
    <span class="image fit main bottom"><img src="{{ asset('/landed/images/pic04.jpg') }}" alt="" /></span>
    <div class="content">
        <header>
